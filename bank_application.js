    ...
    for (let i = 0; i < localStorage.length; i++) {
        ...
        if (key.startsWith('entry_')) { // Check if the key starts with 'entry_'
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-black-500 dark:hover:bg-blue-700">
                ...
                <button class="bg-green-500 px-1 py-0.5 w-full rounded mt-1" onclick="edit(this, ${entry.ac_no})">EDIT</button>
                <br>
                <button class="bg-red-500 px-1 py-0.5 rounded w-full mt-1" onclick="del(this, ${entry.ac_no})">DELETE</button>
                <br>
                <button class="bg-blue-600 px-1 py-0.5 rounded w-full mt-1" onclick="depo(this, ${entry.ac_no})">DEPOSIT</button>
                <br>
                <button class="bg-yellow-600 px-1 py-0.5 rounded w-full mt-1" onclick="withd(this, ${entry.ac_no})">WITHDRAW</button>
                </td>
            </tr>
            `;
